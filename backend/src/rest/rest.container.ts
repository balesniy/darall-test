...
import { DatabaseClient, PrismaService } from '../shared/libs/database-client/index.js';
...
export function createRestApplicationContainer() {
  ...
  restApplicationContainer.bind<DatabaseClient>(Component.DatabaseClient).toDynamicValue(() => new PrismaService());
